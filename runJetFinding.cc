...
void DoJet(treeWriter &Writer, JetDefinition &Definition, AreaDefinition Area,
   ...
   Selector &JetSelector, string Tag, string TheoryTag);
...
int main(int argc, char *argv[])
{
   ...
   string TheoryTag = cmdline.value<string>("-tag");
   ...
   JetDefinition JetDefinition03(antikt_algorithm, 0.3);
   ...
   JetDefinition WTADefinition03(antikt_algorithm, 0.3, WTA_pt_scheme);
   ...
   while ( mixer.next_event() && iEvent < EventCount )
   {
      ...
      //---------------------------------------------------------------------------
       ...
       DoJet(Writer, JetDefinition02, Area, JetDefinition01, WTADefinition, 0.2, ParticlesSignal, ParticlesDummy, JetSelector, "SignalJet02",TheoryTag);
       DoJet(Writer, JetDefinition03, Area, JetDefinition01, WTADefinition, 0.3, ParticlesSignal, ParticlesDummy, JetSelector, "SignalJet03",TheoryTag);
       DoJet(Writer, JetDefinition04, Area, JetDefinition01, WTADefinition, 0.4, ParticlesSignal, ParticlesDummy, JetSelector, "SignalJet04",TheoryTag);
       DoJet(Writer, JetDefinition06, Area, JetDefinition01, WTADefinition, 0.6, ParticlesSignal, ParticlesDummy, JetSelector, "SignalJet06",TheoryTag);
       DoJet(Writer, JetDefinition08, Area, JetDefinition01, WTADefinition, 0.8, ParticlesSignal, ParticlesDummy, JetSelector, "SignalJet08",TheoryTag);
       DoJet(Writer, JetDefinition10, Area, JetDefinition01, WTADefinition, 1.0, ParticlesSignal, ParticlesDummy, JetSelector, "SignalJet10",TheoryTag);
   ...
   Selector &JetSelector, string Tag, string TheoryTag)
{
   ...
   jetCollection JCTheory(GetCorrectedJets(JC.getJet(), Dummy));

   Writer.addCollection(Tag + "",        JC);
   Writer.addCollection(Tag + TheoryTag,   JCTheory);
}
